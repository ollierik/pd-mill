...
LINUXCFLAGS =-DPD -O3 -funroll-loops -fomit-frame-pointer -fPIC \
    -Wall -W -Wshadow -Wstrict-prototypes -Werror \
    -Wno-unused -Wno-parentheses -Wno-switch -lpthread

LINUXLDFLAGS =  -export_dynamic -shared  -lc -lm

LINUXINCLUDE =  -I$(PDSRCDIR) -I/home/olli/pdwip
...
DARWINCFLAGS = -DPD -O2 -Wall -W -Wshadow -Wstrict-prototypes \
    -Wno-unused -Wno-parentheses -Wno-switch -fPIC -m32
